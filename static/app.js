...
$("#syncButtons").onclick = async e => {
  ...
  try {
    if (module === "ad_campaigns") {
      const result = await api("/api/performance/campaigns/sync", {
        method: "POST",
