...
from .routers.product_commissions import router as product_commissions_router
from .routers.product_costs import router as product_costs_router
...
app.include_router(product_commissions_router)
