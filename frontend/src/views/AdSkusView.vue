...
import { getAdSkuStats, type AdSkuStatsQuery } from "../api/ads";
import { getErrorMessage } from "../api/client";
import { useShop } from "../composables/useShop";
import type { AdSkuItem, AdSkuSort, ShopSelection } from "../types/api";
...
function renderSku(row: AdSkuItem): VNodeChild {
  return h("div", { class: "ad-skus-identity-cell" }, [
    ...
    }, [h("morph-icon", { icon: "copy", size: "12", "stroke-width": "2" }), `SKU ${row.sku}`]),
  ]);
}
