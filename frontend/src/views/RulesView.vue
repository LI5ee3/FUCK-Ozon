...
import { deleteShortName, dissolveMergeGroup, getProductRules, saveMergeGroup, saveShortName } from "../api/rules";
import { getErrorMessage } from "../api/client";
import { copyText } from "../utils/clipboard";
import { formatBeijingDateTime, formatInteger } from "../utils/format";
import type {
  ProductRuleGroup,
  ProductRuleMember,
